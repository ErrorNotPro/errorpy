...
sto = {"stop":False}
token = "7364013329:AAHnUPUqNW-92C6l6plVIJpOilzFDo-WyCM"
id = 6181269269
...
[×] 𝐑𝐞𝐩𝐨𝐬𝐞 : <code>Insufficient Funds</code>

[×] 𝐁𝐚𝐧𝐤 🏦 : <code>{bank}</code>
[×] 𝐁𝐢𝐧 𝐈𝐧𝐟𝐨 💳 : <code>{ii}</code>
[×] 𝐂𝐨𝐮𝐧𝐭𝐫𝐲 🌏 : <code>{do}</code>

[×] 𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 🌤️ - @BR0KEN_CC'''
...
[×] 𝐂𝐂 : {cc}
[×] 𝐒𝐭𝐚𝐭𝐮𝐬 : Approved ✅
[×] 𝐑𝐞𝐩𝐨𝐬𝐞 : Nice! New payment method
...
[×] 𝐂𝐂 : <code>{cc}</code>
[×] 𝐒𝐭𝐚𝐭𝐮𝐬 : <code>Approved ✅</code>
[×] 𝐑𝐞𝐩𝐨𝐬𝐞 : <code>Nice! New payment method</code>
